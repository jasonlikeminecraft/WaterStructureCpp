...
set_arch("x64")
set_toolchains("msvc")
add_cxxflags("/utf-8", "/bigobj", "/wd4838", "/wd4828", { force = true })
add_defines("WIN32_LEAN_AND_MEAN", "NOMINMAX", "LEVELDB_PLATFORM_WINDOWS", "LEVELDB_COMPILE_LIBRARY")
...
target("leveldb")
    ...
    add_files(
        ...
        "thirdparty/LevelDB/util/env_windows.cc",
