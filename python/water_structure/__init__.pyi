...
class Context:
    ...
    def convert(self, input_path: PathValue, target_format: str, output_path: PathValue, *, threads: int = 0, clear_air: bool = True, chunk_partition: bool = False, progress: Optional[Callable[[Progress], object]] = None) -> None: ...
